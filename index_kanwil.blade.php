                     ...
                     stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path
                            ...
                            d="M19 11l0 2"/></svg>
                                                    ...
                                                    <select name="kode_divisi_pilihan" id="kode_divisi_pilihan"
                                                        ...
                                                        <option {{ Request('kode_divisi_pilihan')=='all_berita'?'selected':'' }} value="all_berita">SEMUA BERITA</option>
                                                        <option {{ Request('kode_divisi_pilihan')=='berita_umum'?'selected':'' }} value="berita_umum">BERITA UMUM</option>
                                                        @php
                                                            $getall_divisi = DB::table('divisi')->get();

                                                        @endphp
                                                        @foreach($getall_divisi as $key=>$d)
                                                            <option {{ Request('kode_divisi_pilihan')==$d->kode_divisi?'selected':'' }} value="{{ $d->kode_divisi }}">{{ $d->nama_divisi }} ( {{ $d->kode_divisi }} )
                                                            </option>
                                                        @endforeach
                                ...
                                <div class="col-12">
                                    <table class="table table-bordered"
                                        ...
                                        <tr>
                                            ...
                                            <th hidden style="width: 100px;">Divisi</th>
                                        ...
                                        @foreach($berita_satker as $d)
                                           ...
                                           margin: 0 auto; overflow-x: auto; white-space: nowrap;">
                                                    @php
                                                        ...
                                                        if($d->kode_divisi!=''){
                                                            if($d->kode_divisi!='berita_umum'){
                                                                $dt_divisi = DB::table('divisi')
                                                                   ->where('kode_divisi', $d->kode_divisi)->get();
                                                                foreach ($dt_divisi as $dt){
                                                                    echo $dt->nama_divisi;
                                                                }
                                                            } else {
                                                                echo "Berita Umum";
                    ...
                    <form action="{{  route('storeberita') }}" method="post" id="frmBeritaSatker" name="frmBeritaSatker"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" name="jumlah[]" id="jumlah[]"
                                                                   ...
                                                                   placeholder="Judul Berita|||Link Media Lokalllll">
                                                        </div>
                        ...
                        <div class="row" style="margin-bottom: 10px; margin-top: 15px;">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="">
                                        <center><label class="col-lg-12 " style="font-weight: bold;">Pilih Urutan Prioritas</label>
                                        </center>
...
@push('myscript')
    <script>
        $(function () {
            ...
            /*KOLOM TAMBAHAN UTK MEDIA LOKAL DARI SINI*/
            ...
            /*KOLOM TAMBAHAN UTK MEDIA LOKAL SAMPAI SINI*/

            /*KOLOM TAMBAHAN UTK MEDIA NASIONAL DARI SINI*/
            $(add_button_nasional).click(function (e) { //on add input button click
                //alert("woy");
                //return false;
                e.preventDefault();
                if (x_nasional < max_fields_nasional) {
            ...
            /*KOLOM TAMBAHAN UTK MEDIA NASIONAL SAMPAI SINI*/
            ...
            $('#frmBeritaSatker').submit(function () {
                ...
                var prioritas = $('#frmBeritaSatker').find('#id_prioritas').val();
