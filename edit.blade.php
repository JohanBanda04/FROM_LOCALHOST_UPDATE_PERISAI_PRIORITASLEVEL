<form action="{{ route('updateberita', $berita->id_berita) }}" method="post" id="frmSatkerBeritaEdit"
        ...
        <div class="col-12">
            <div class="form-group">
                <div class="input_fields_wrap_edit">
                    <center>
                        <label class="col-lg-12 " style="">Link Tambahan (SMedia LokaL)</label>
                    </center>
    ...
    <div class="row" style="margin-bottom: 10px; margin-top: 15px;">
        <div class="col-12">
            <div class="form-group">
                <div class="input_fields_wrap_edit_nasional">
                    <center><label class="col-lg-12 " style="font-weight: bold;">Pilih Divisi Pemilik Giat</label>
                    </center>
                    ...
                    <div class="row" id="list-file-mednas-<?= $key_nasional?>-<?= $berita->id_berita?>">
                        <div class="col-12">
                            <div class="input-icon mb-1">
                                <div class="row">
                                    <div class="col-12">
                                        <select required name="kode_divisi" id="kode_divisi"
                                                class="form-select">
                                            <option value="">-Pilih Divisi-</option>
                                            <option {{ $berita->kode_divisi=="berita_umum"?'selected':'' }} value="berita_umum">-Berita Umum-</option>
                                            @foreach($getdivisi as $idx=>$divisi)
                                                <option {{ $divisi->kode_divisi==$berita->kode_divisi?'selected':'' }} value="{{ $divisi->kode_divisi }}">
                                    ...
                                    <div class="col-12">
                                        <select name="id_prioritas"
                                            ...
                                            @foreach($dataPrioritas as $ind=>$dp)
                                                <option {{ $dp->id_prioritas==$berita->prioritas_id?'selected':'' }} value="{{ $dp->id_prioritas }}">
...
<script type="text/javascript">
    ...
    function addFileMednas($row_id_berita) {
        ...
        var html4 = '<div class="form-group input-dinamis m-20 mt-2" id="' + divIdMednas + '">' +
            ...
            '@foreach($getmedia as $idx=>$media_nasional)@if($media_nasional->jenis_media=="media_nasional") <option value="{{ $media_nasional->kode_media }}">{{ $media_nasional->name }}</option> @endif @endforeach' +
            '</select></div>' +
